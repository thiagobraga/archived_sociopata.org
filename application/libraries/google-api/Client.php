...
require_once APPPATH . 'libraries/google-api/Auth/AssertionCredentials.php';
require_once APPPATH . 'libraries/google-api/Cache/File.php';
require_once APPPATH . 'libraries/google-api/Cache/Memcache.php';
require_once APPPATH . 'libraries/google-api/Config.php';
require_once APPPATH . 'libraries/google-api/Collection.php';
require_once APPPATH . 'libraries/google-api/Exception.php';
require_once APPPATH . 'libraries/google-api/IO/Curl.php';
require_once APPPATH . 'libraries/google-api/IO/Stream.php';
require_once APPPATH . 'libraries/google-api/Model.php';
require_once APPPATH . 'libraries/google-api/Service.php';
require_once APPPATH . 'libraries/google-api/Service/Resource.php';
