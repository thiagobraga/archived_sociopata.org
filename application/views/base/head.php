<head>
	...
	<!-- CSS -->
	<link href="<?php echo base_url("assets/dist/css/styles.min.css") ?>" rel="stylesheet" type="text/css" />
	<?php if (isset($css)) : ?>
		<?php foreach ($css as $file) : ?>
			<link href="<?php echo base_url("assets/src/css/" . $file . ".css") ?>" rel="stylesheet" type="text/css" />
		<?php endforeach ?>
	<?php endif ?>

	<!-- PREFIX-FREE -->
	<script src="<?php echo base_url('assets/src/js/plugins/prefixfree.js') ?>" type="text/javascript"></script>
</head>